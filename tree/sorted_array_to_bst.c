 ...
 * Array to BST
 *
 * Given a sorted array. Convert it into a Height balanced 
 * Binary Search Tree (BST).
 * Height balanced BST means a binary tree in which the depth of the two
 * subtrees of every node never differ by more than 1.
 *
 * Solution : We will use AVL tree to insert our nodes from a sorted array.
 *
